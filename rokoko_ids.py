...
CM_SUBID_CONNECTION_CONNECT_ERROR = 5
...
# Bool option replaced by ID_DLGSAVE_TARGET_TAKE
...
MR_Y180 = c4d.Matrix(c4d.Vector(0.0),
                     c4d.Vector(-1.0, 0.0, 0.0),
                     c4d.Vector(0.0, 1.0, 0.0),
